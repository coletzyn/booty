...
contract Flashloan is ICallee, DydxFlashloanBase {
    ...
    function callFunction(
        ...
        uint256 balanceaave = aave.balanceOf(address(this));
        ...
        if(arbInfo.direction == Direction.SushiToUniswap) {
          ...
          uniswap.swapTokensForExactETH.value(address(this).balance)(
            balanceWeth,
            minOuts2[1], 
            path2, 
            address(this), 
          ...
          path2[0] = address(aave);
          path2[1] = address(weth);
          uint[] memory minOuts2 = sushi.getAmountsOut(balanceaave, path2); 
          sushi.swapTokensForExactETH( 
            balanceaave,
            minOuts2[1], 
            path2, 
            address(this), 
